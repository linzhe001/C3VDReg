...
def options(argv=None):
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="PATH",
        help="path to the result of the test (.csv)",
    )  # see. 'test_pointlk.py'
    parser.add_argument(
        "--val", default="#N/A", type=str, metavar="VAL", help="info. for the x-axis"
    )
    parser.add_argument(
        "--hdr", dest="hdr", action="store_true", help="outputs header line"
    )
